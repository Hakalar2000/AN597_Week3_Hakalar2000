...
#We want to plot the discrete values for 0 to 30 for our poisson distribution which is why we used dpois. 
...
#Thanks, this is helpful. Am keeping this comment here for future reference if needed. 
```
...
#Now comparing my histogram to the shape of the PMF above: In general, the shape of the histogram has a peak over 15 calls (just like the PMF) and a gradual decrease in the frequency of call number as you go from higher to a lower number of calls. 
```
