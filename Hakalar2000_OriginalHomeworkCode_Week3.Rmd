...
?plot
plot(dpois(x = 0:30, lambda = 15), type = "l", xlab = "Number of Calls", ylab = "Probability", main = "Poisson Mass Function")
#We want to plot the discrete values for 0 to 30 for our poisson distribution which is why we used dpois. The type specifies the type of graph, in this case, l tells R to make a line graph. xlab, ylab, and main label the axises. 
```
