...
#FA: Here you can define the Poisson simulation (eg: sim<-rpois), same as you did for the probabilities, this can be helpful for question 6 - since question 6 is asking to run the simulated results from question 5.
```
...
#FA: I think here you can only call the sim function from question 5 (eg: hist(sim, ...).
```
...
#FA: Thanks for your comments to my code, I will define the prob function as you suggested - in general our codes look the same, with two minor comments for question 5 and 6, and same like you I have some doubts about question 4.